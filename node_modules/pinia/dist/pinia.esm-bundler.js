/*!
  ...
  * @license MIT
  */
import { warn, ref, getCurrentInstance, inject, provide, computed, reactive, watch, onUnmounted } from 'vue';
        ...
        if (!isAlreadyInstalled) {
            ...
            api.on.editInspectorState((payload) => {
                if (payload.app === app && payload.inspectorId === INSPECTOR_ID) {
                    ...
                    const { path } = payload;
                    if (path[0] !== 'state') {
                        return toastMessage(`Invalid path for store "${payload.nodeId}":\n${path}\nOnly state can be modified.`);
                    }
...
export { MutationType, createPinia, createStore, defineStore, mapActions, mapGetters, mapState, mapStores, mapWritableState, setActivePinia, setMapStoreSuffix };
